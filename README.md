...
Before loading the data to the Qdrant cluster, we perform the following pre-processing steps:
...
These steps reduce the number of unqiue items to 163, maintaing only the clean and filtered information we require for the agent.
